	...
	<div class='container'>
		...
		<form action ='index.php' method='GET'>
			<p class='options'>
				...
				<?php if(isset($numOfWords)){echo "value=\"".$numOfWords."\" ";} ?>>  (Max 9)
				<br>

				<input type='checkbox' name='add_number' id='add_number' value='on'
				<?php if(isset($_GET['add_number']) && $_GET['add_number'] == 'on'){echo "checked=\"checked\" ";} ?>>
				<label for='add_number'>Add a number</label>
				<br>

				<input type='checkbox' name='add_symbol' id='add_symbol' value='on'
				<?php if(isset($_GET['add_symbol']) && $_GET['add_symbol'] == 'on'){echo "checked=\"checked\" ";} ?>>
